  ...
  script =
    ...
    pkgs.writeShellScriptBin name # bash
      ''
        ...
        hosts="$(nix eval ${root}#nixosConfigurations --apply 'hosts: builtins.concatStringsSep " " (builtins.attrNames hosts)')"
        hosts=''${hosts#\"}
        hosts=''${hosts%\"}
        ...
        # Build image
        nix build ${root}#nixosConfigurations.''${host}.config.system.build.isoImage
