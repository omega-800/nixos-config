...
{ config, usr, ... }: {
  programs.bash = {
    ...
    bashrcExtra = with config.lib.stylix.colors; ''
      ...
      #PS1="\n$(tput setaf "$(fromhex "#${base08}")")\u $(tput setaf "$(fromhex "#${base0A}")")\w\n$(tput setaf "$(fromhex "#${base06}")")\h $(tput setaf "$(fromhex "#${base03}")")\j $(tput setaf "$(fromhex "#${base00}")")\s $(tput setaf "$(fromhex "#${base0E}")")\! $(tput setaf "$(fromhex "#${base0B}")")> $(tput sgr0)"
